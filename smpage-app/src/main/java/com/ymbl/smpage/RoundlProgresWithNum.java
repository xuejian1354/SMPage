...
public class RoundlProgresWithNum extends CustomHorizontalProgresNoNum{
    ...
    private int color = HorizontalProgresUnReachColor;
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.parseColor("#aaeeeeee"));
        mPaint.setStrokeWidth(mCustomCircleRadio);
        ...
        if (mCustomHasNum){
            if(title.equals("空气质量")) {
                ...
                canvas.drawText(val, 0 - mRectF.width() / 2, mRectF.height()/2, mPaint);

                mPaint.setTextSize(40);
                mPaint.setColor(Color.parseColor("#330000"));
                canvas.drawText(title, 0 - mRectF.width() / 3, mRectF.height() *3/2, mPaint);
            }
            else {
                mPaint.setColor(color);
                ...
                mPaint.getTextBounds(currentProgress, 0, currentProgress.length(), mRectF);
                //canvas.drawText(currentProgress,mRectF.width(),mRectF.height(),mPaint);
                if(title.equals("温度") || title.equals("湿度")) {
                    canvas.drawText(val, 0 - mRectF.width()*2/3, 0, mPaint);
                }
                else {
                    canvas.drawText(val, 0 - mRectF.width() / 2, 0, mPaint);
                }
